#  NYC Citi Bike | Demand Intelligence Core
...
|  **Production Dashboard** | Interactive CartoDB heatmaps, Recharts demand graphs, real-time MAE/RMSE/MAPE + feature importances |
